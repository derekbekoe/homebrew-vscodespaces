...
class Vso < Formula
  ...
  url "https://vsoagentdownloads.blob.core.windows.net/vsoagent/VSOAgent_osx_3682089.zip"
  # must be lower-case
  sha256 "bc30a8c517537a146193c053603867e46397fb645a87f670afe7bd337bcef7a0"
  bottle :unneeded
